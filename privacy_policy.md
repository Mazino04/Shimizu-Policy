...
Firebase Analytics collects anonymous usage data, including country-level geolocation information. This helps us understand how Shimizuis being used across different regions.

### Third-Party Authentication and Integration
Shimizu allows you to authenticate with the following third-party services:
- AniList
- MyAnimeList
- Discord
...
This information is only shared while you are actively using Shimizuand have Discord RPC enabled.
...
- GitHub: [Shimizu Issues](https://github.com/Mazino04/Shimizu/issues)
- Discord: "@mazino04"
- AniList: "mazino04"
